...
8. **Leave no learner behind.** You will learn later in the workshop [how sticky notes can be used to gauge learners' progress and understanding]({{page.root}}{% link _episodes/17-management.md %}#sticky-notes).
